...
public class SeleniumOperations {
	...
	public static void open_chrome_loadpage_resize_close() {
		...
		System.out.println("Hello from <s223193507>, <Ayesha Rana>");
        ...
        // C. Resize the browser window to 640x480 and wait 2 seconds.
        ...
        // D. Resize the window to 1280x960 and wait 2 seconds.
